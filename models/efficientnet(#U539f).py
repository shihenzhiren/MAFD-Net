"""
EfficientNet implementation with intermediate feature extraction support
Modified from original Tensorflow implementation: https://github.com/tensorflow/tpu/tree/master/models/official/efficientnet
"""
...
class EfficientNet(nn.Module):
    def __init__(self, phi_value, num_classes=1000, include_top=True, feat_mult=1.0):
        ...
        phi = phi_value
        width_mult = width_coefficient[phi] * feat_mult
        ...
        idx = 0
        for t, c, n, s, k in stage_configs:
            ...
            idx += len(layers)
        self.feature_indices.append(idx)  # For final conv
...
def efficientnet_b0(num_classes=1000):
    return _efficientnet(0, num_classes)


def efficientnet_b1(num_classes=1000):
    return _efficientnet(1, num_classes)


def efficientnet_b2(num_classes=1000):
    return _efficientnet(2, num_classes)


def efficientnet_b3(num_classes=1000):
    return _efficientnet(3, num_classes)


def efficientnet_b4(num_classes=1000):
    return _efficientnet(4, num_classes)


def efficientnet_b5(num_classes=1000):
    return _efficientnet(5, num_classes)


def efficientnet_b6(num_classes=1000):
    return _efficientnet(6, num_classes)


def efficientnet_b7(num_classes=1000):
    return _efficientnet(7, num_classes)


if __name__ == '__main__':
    x = torch.randn(2, 3, 224, 224)

    for model_fn in [efficientnet_b0, efficientnet_b7]:
        print(f"\nTesting {model_fn.__name__}")
